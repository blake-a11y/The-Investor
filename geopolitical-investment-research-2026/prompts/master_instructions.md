...
**Copy-paste this entire block to Grok, Claude, Gemini, or ChatGPT as the first message.**
...
| AI | First message |
|----|---------------|
| **Grok** | Paste full block above + add: "You already have the full conversation history — use it." |
| **Claude / Gemini / ChatGPT** | Paste full block + paste key previous messages or this summary at the top. |
